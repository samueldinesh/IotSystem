...
def list_rules(args):
    ...
    table = PrettyTable()
    table.field_names = ["ID", "Name", "Type", "Primary Sensor", "Condition", "Duration(s)", "Shunt Sensor", "Shunt Condition"]
    ...
    for r in rules:
        ...
        table.add_row([r['id'], r['name'], r['type'], r['primary_sensor'], condition, r['duration'], shunt_sensor, shunt_condition])
